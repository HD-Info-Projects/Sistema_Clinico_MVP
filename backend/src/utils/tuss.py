...
TIPO_PROCEDIMENTO_LABELS = {
    ...
    TIPO_PROCEDIMENTO_AMBULATORIAL: "Procedimentos",
    TIPO_PROCEDIMENTO_CIRURGIA: "Cirurgias",
    TIPO_PROCEDIMENTO_METODOS_ELETROFISIOLOGICOS: "Métodos Funcionais",
    TIPO_PROCEDIMENTO_ENDOSCOPIA: "Endoscopia",
    TIPO_PROCEDIMENTO_MEDICINA_LABORATORIAL: "Laboratório",
    TIPO_PROCEDIMENTO_MEDICINA_TRANSFUSIONAL: "Hemoterapia",
    TIPO_PROCEDIMENTO_GENETICA: "Genética",
    TIPO_PROCEDIMENTO_ANATOMIA_PATOLOGICA: "Anatomia Patológica",
    TIPO_PROCEDIMENTO_MEDICINA_NUCLEAR: "Medicina Nuclear",
    TIPO_PROCEDIMENTO_RADIOLOGIA_RX: "Radiologia",
    TIPO_PROCEDIMENTO_ULTRASSONOGRAFIA_US: "Ultrassonografia",
    TIPO_PROCEDIMENTO_TOMOGRAFIA_COMPUTADORIZADA: "Tomografia",
    TIPO_PROCEDIMENTO_RESSONANCIA_MAGNETICA: "Ressonância",
    TIPO_PROCEDIMENTO_RADIOTERAPIA: "Radioterapia",
    TIPO_PROCEDIMENTO_EXAMES_ESPECIFICOS: "Exames Específicos",
    TIPO_PROCEDIMENTO_TESTES_DIAGNOSTICO: "Testes Diagnósticos",
    TIPO_PROCEDIMENTO_OUTROS_DIAGNOSTICOS_TERAPEUTICOS: "Outros Diagnósticos",
    TIPO_PROCEDIMENTO_OUTROS: "Outros",
